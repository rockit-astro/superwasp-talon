...
void s_stow(Widget w, XtPointer client, XtPointer call)
{
 ...
 */
void s_edit(Widget w, XtPointer client, XtPointer call)
{
    static char blanks[] = "";
...
/* requires alt/az */
void s_goto(Widget w, XtPointer client, XtPointer call)
{
    String altstr, azstr;
    double alt, az;
...
static char *rcsid[2] = {(char *)rcsid,
                         "@(#) $RCSfile: scope.c,v $ $Date: 2006/01/13 20:42:47 $ $Revision: 1.1.1.1 $ $Name:  $"};
