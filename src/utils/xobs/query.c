...
Widget tw;
{
	...
	XtSetArg(args[n], XmNtitle, "XObs Query");  n++;
...
static char *rcsid[2] = {(char *)rcsid, "@(#) $RCSfile: query.c,v $ $Date: 2006/01/13 20:42:47 $ $Revision: 1.1.1.1 $ $Name:  $"};
