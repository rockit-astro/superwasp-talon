...
static void
recordStartup (char *title, int ac, char *av[])
{
	char cmd[2048];
	int l = 0;
...
static char *rcsid[2] = {(char *)rcsid, "@(#) $RCSfile: rund.c,v $ $Date: 2006/01/13 20:43:22 $ $Revision: 1.1.1.1 $ $Name:  $"};
