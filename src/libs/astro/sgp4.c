 ...
 * at its epoch + TSINCE.
 */
void sgp4(sat, pos, dpos, TSINCE) SatData *sat;
Vec3 *pos;
Vec3 *dpos;
double TSINCE;
{
    ...
    double A1, A3OVK2, AO, BETAO, BETAO2, C1SQ, C2, C3, COEF, COEF1, DEL1, DELO, EETA, EOSQ, ETASQ, PERIGE, PINVSQ,
        PSISQ, QOMS24, S4, TEMP, TEMP1, TEMP2, TEMP3, THETA2, THETA4, TSI, X1M5TH, XHDOT1;

    double A, AXN, AYN, AYNL, BETA, BETAL, CAPU, COS2U, COSEPW, COSIK, COSNOK, COSU, COSUK, DELM, DELOMG, E, ECOSE,
        ELSQ, EPW, ESINE, OMEGA, OMGADF, PL, R, RDOT, RDOTK, RFDOT, RFDOTK, RK, SIN2U, SINEPW, SINIK, SINNOK, SINU,
        SINUK, TCUBE, TEMP4, TEMP5, TEMP6, TEMPA, TEMPE, TEMPL, TFOUR, TSQ, U, UK, UX, UY, UZ, VX, VY, VZ, XINCK, XL,
        XLL, XLT, XMDF, XMP, XMX, XMY, XN, XNODDF, XNODE, XNODEK;
    ...
    if (!sat->prop.sgp4)
    {
        ...
        XMDOT = XNODP + .5 * TEMP1 * BETAO * X3THM1 + .0625 * TEMP2 * BETAO * (13.0 - 78.0 * THETA2 + 137.0 * THETA4);
    ...
    RK = R * (1.0 - 1.5 * TEMP2 * BETAL * X3THM1) + .5 * TEMP1 * X1MTH2 * COS2U;
