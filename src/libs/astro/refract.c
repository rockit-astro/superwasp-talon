...
void unrefract(pr, tr, aa, ta) double pr, tr;
double aa;
double *ta;
{
#define LTLIM 14.5
...
static void unrefractGE15(pr, tr, aa, ta) double pr, tr;
double aa;
double *ta;
{
    double r;
...
static void unrefractLT15(pr, tr, aa, ta) double pr, tr;
double aa;
double *ta;
{
    double aadeg = raddeg(aa);
 ...
 */
void refract(pr, tr, ta, aa) double pr, tr;
double ta;
double *aa;
{
...
static char *rcsid[2] = {(char *)rcsid,
                         "@(#) $RCSfile: refract.c,v $ $Date: 2006/01/13 20:43:56 $ $Revision: 1.1.1.1 $ $Name:  $"};
