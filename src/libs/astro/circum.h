...
#define set_ratio(op, maj, min) ((op)->f_ratio = (byte)(((maj) > 0) ? ((min)*SRSCALE / (double)(maj) + 0.5) : 0))
...
#define ALLM (FIXEDM | HYPERBOLICM | PARABOLICM | EARTHSATM | ELLIPTICALM | PLANETM)
 ...
 * @(#) $RCSfile: circum.h,v $ $Date: 2006/01/13 20:43:54 $ $Revision: 1.1.1.1 $ $Name:  $
 */
