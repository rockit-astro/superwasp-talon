 ...
 */
void aa_hadec(lat, alt, az, ha, dec) double lat;
double alt, az;
double *ha, *dec;
{
 ...
 */
void hadec_aa(lat, ha, dec, alt, az) double lat;
double ha, dec;
double *alt, *az;
{
 ...
 * latitude, psi.
 */
double geoc_lat(phi) double phi;
{
 ...
 */
static void aaha_aux(lat, x, y, p, q) double lat;
double x, y;
double *p, *q;
{
