...
{
    double A1, A10, A2, A3, A4, A5, A6, A7, A8, A9, AINV2, AQNV, BFACT, C, CC, COSQ, CTEM, DAY, DS50, EOC, EQ, F220,
        F221, F311, F321, F322, F330, F441, F442, F522, F523, F542, F543, G200, G201, G211, G300, G310, G322, G410,
        G422, G520, G521, G532, G533, GAM, PREEP, S1, S2, S3, S4, S5, S6, S7, SE, SGH, SH, SI, SINI2, SINQ, SL, STEM,
        TEMP, TEMP1, X1, X2, X3, X4, X5, X6, X7, X8, XMAO, XNO2, XNODCE, XNOI, XPIDOT, Z1, Z11, Z12, Z13, Z2, Z21, Z22,
        Z23, Z3, Z31, Z32, Z33, ZCOSG, ZCOSGL, ZCOSH, ZCOSHL, ZCOSI, ZCOSIL, ZE, ZMO, ZN, ZSING, ZSINGL, ZSINH, ZSINHL,
        ZSINI, ZSINIL, ZX, ZY;
    ...
    if (XNQ <= .0034906585 || XNQ >= .0052359877)
    {
        ...
        F522 = 9.84375 * SINIQ *
               (SINI2 * (1.0 - 2.0 * COSIQ - 5.0 * COSQ2) + .33333333 * (-2.0 + 4.0 * COSIQ + 6.0 * COSQ2));
    ...
    else
    {
        ...
        F311 = .9375 * SINIQ * SINIQ * (1.0 + 3.0 * COSIQ) - .75 * (1.0 + COSIQ);
        F330 = 1.0 + COSIQ;
...
{
    double SINIS, COSIS, ZM, ZF, SINZF, F2, F3, SES, SIS, SLS, SEL, SIL, SLL, PGH, PH, SINOK, COSOK, ALFDP, BETDP, DALF,
        DBET, XLS, DLS;
...
static char *rcsid[2] = {(char *)rcsid,
                         "@(#) $RCSfile: deep.c,v $ $Date: 2006/01/13 20:43:54 $ $Revision: 1.1.1.1 $ $Name:  $"};
