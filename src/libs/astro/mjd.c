 ...
 * *mjd.
 */
void cal_mjd(mn, dy, yr, mjd) int mn, yr;
double dy;
double *mjd;
{
 ...
 */
void mjd_cal(mjd, mn, dy, yr) double mjd;
int *mn, *yr;
double *dy;
{
    static double last_mjd, last_dy;
 ...
 */
int mjd_dow(mjd, dow) double mjd;
int *dow;
{
...
void mjd_dayno(mjd, yr, dy) double mjd;
int *yr;
double *dy;
{
    double yrd;
...
void mjd_year(mjd, yr) double mjd;
double *yr;
{
