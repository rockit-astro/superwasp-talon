 ...
 */
int funcmax(double (*f)(double x), double x0, double dy, double *xmaxp)
{
    double xmax, ymax;
    double x[3];
    double y[3];
 ...
 */
int parabmax(double x[3], double y[3], double *maxp)
{
    double y10 = y[1] - y[0];
    double y12 = y[1] - y[2];
    double x0 = x[0];
...
static char *rcsid[2] = {(char *)rcsid,
                         "@(#) $RCSfile: funcmax.c,v $ $Date: 2006/01/13 20:44:03 $ $Revision: 1.1.1.1 $ $Name:  $"};
