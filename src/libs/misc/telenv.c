 ...
 */
void telfixpath(char *new, char *old)
{
    char tmp[1024];
...
char *timestamp(time_t t)
{
    ...
    if (!tmp)
        ...
        sprintf(str, "%04d%02d%02d%02d%02d%02d", tmp->tm_year + 1900, tmp->tm_mon + 1, tmp->tm_mday, tmp->tm_hour,
...
static char *rcsid[2] = {(char *)rcsid,
                         "@(#) $RCSfile: telenv.c,v $ $Date: 2006/01/13 20:44:04 $ $Revision: 1.1.1.1 $ $Name:  $"};
