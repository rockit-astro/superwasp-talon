...
extern int lastSkyCCD (char *buf);
extern int lastFileNameCCD (char *buf);
extern int scratchOnCCD (char *buf);
extern int scratchOffCCD (char *buf);
#endif	/* __KERNEL__ */

#endif	/* _CCDCAM_H */

/* For RCS Only -- Do Not Edit
 * @(#) $RCSfile: ccdcamera.h,v $ $Date: 2006/01/13 20:44:02 $ $Revision: 1.1.1.1 $ $Name:  $
 */
