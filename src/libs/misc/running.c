 ...
 */
void unlock_running(char *name, int killtoo)
{
    char fn[1024];
    int pid;
    int us;
 ...
 */
int testlock_running(char *name)
{
    char fn[1024];
    int pid;
...
static char *rcsid[2] = {(char *)rcsid,
                         "@(#) $RCSfile: running.c,v $ $Date: 2006/01/13 20:44:03 $ $Revision: 1.1.1.1 $ $Name:  $"};
